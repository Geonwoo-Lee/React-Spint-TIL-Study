...
| 요일 | 일정 | 참여자 | 시간 |  주차  |
|---|---|---|---|---|
| 월 | TIL, Sprint, React, Algorithm | 이건우, 이장희, 김동우| 자율 | 8 |
| 화 | TIL, Sprint, React, Algorithm | 이건우, 이장희, 김동우| 자율 | - |
| 수 | TIL, Sprint, React, Algorithm | 이건우, 이장희, 김동우| 자율 | - |
| 목 | 스터디 회의 | 이건우, 이장희, 김동우| 미정 | - |
| 금 | TIL, Sprint, React, Algorithm | 이건우, 이장희, 김동우| 미정 | - |
...
* Sprint 10주차 Schedule

| 요일 | 일정 | 참여자 | 시간 |  주차  |
|---|---|---|---|---|
| 월 | 광복절 대체공휴일| 이건우, 이장희, 김동우| 자율 | 10 |
| 화 | TIL, Sprint, React, Algorithm | 이건우, 이장희, 김동우| 자율 | - |
| 수 | HA | 이건우, 이장희, 김동우| 자율 | - |
| 목 | HA | 이건우, 이장희, 김동우| 자율 | - |
| 금 | 스터디 회의 | 이건우, 이장희, 김동우| 미정 | - |
...
* Sprint 마지막 주차 Schedule

| 요일 | 일정 | 참여자 | 시간 |  주차  |
|---|---|---|---|---|
| 일 |1. 프로젝트에 대한 아이디어 회의 각자 웹사이트들을 둘러보면서 영감을 받거나 좋다고 생각 되는 부분을 생각해서 "~이러이러한 부분이 좋은 것 같아서 이러이러하게 하면 어떨까요?" 정도만 생각해보기 부담 X 스터디 레포를 새로 짤 계획인데 그 스터디 레포에서 어떤 기능이 있으면 좋을 것 같은지 생각해보기 없으면 없다고 하셔도 됩니다 ! 간단하게 예를 들자면 "매주 ToDo list를 작성해서 그에 맞는 공부 방향성을 잡게 할 수 있으면 좋을것 같습니다~ "등등 | 이건우, 이장희, 김동우, 정종화| 자율 | 마지막 주차 |
